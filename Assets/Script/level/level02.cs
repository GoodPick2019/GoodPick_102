...
namespace Level
{
    ...
    {
        public GameObject one, two, three, four, five, six, seven, eight, oneblack, twoblack, threeblack, fourblack, fiveblack, sixblack, sevenblack, eightblack;
        public GameObject redheart1, redheart2, redheart3, failed, success;
        Vector2 oneInitialPos, twoInitialPos, threeInitialPos, fourInitialPos, fiveInitialPos, sixInitialPos, sevenInitialPos, eightInitialPos;
        public static bool oneCorrect, twoCorrect, threeCorrect, fourCorrect, fiveCorrect, sixCorrect, sevenCorrect, eightCorrect;
        ...
        void Update()
        {
            ...
            if (oneCorrect && twoCorrect && threeCorrect && twoCorrect && fourCorrect && twoCorrect && fiveCorrect && sixCorrect && sevenCorrect && eightCorrect)
            {
